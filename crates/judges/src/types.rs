...
/// to attribute and persist scores. Kept as a single value so
/// `Judges::spawn_score` and `Judge::score` don't drift into 8-arg
/// signatures whenever a new field (turn id, language, etc.) needs to ride
/// along.
#[derive(Clone, Debug)]
